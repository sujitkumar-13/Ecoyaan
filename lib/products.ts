...
export function getProducts(): Product[] {
    return [
        ...
        // We can add a "Paper Pencil (Plantable Seed)" specifically to match the screenshot if needed,
        // but for now we'll just use the existing products to populate the dynamic detail page.
        {
            id: 107,
            name: "Paper Pencil (Plantable Seed) - Pack of 10",
            price: 219,
            oldPrice: 229,
            image: "/bag.jpeg", // Placeholder image
            images: ["/bag.jpeg", "/brush.jpg", "/wraps.jpeg"], // Mixing up placeholders
